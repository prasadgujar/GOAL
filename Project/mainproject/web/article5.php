...
<link href="vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    ...
    <!-- Custom styles for this template -->
    <link href="css/blog-post.css" rel="stylesheet"><!-- //custom-theme -->
    <link href="css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
    <link href="css/JiSlider.css" rel="stylesheet">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <hr>
		  <h1><b>FIFA Women’s World Cup</b></h1>
          <!-- Post Content -->
          ...
          <p>Under the tournament's current format, national teams vie for 23 slots in a three-year qualification phase. (The host nation's team is automatically entered as the 24th slot.) The tournament proper, alternatively called the World Cup Finals, is contested at venues within the host nation(s) over a period of about one month.
...
The seven FIFA Women's World Cup tournaments have been won by four different national teams, including the United States, which beat Norway 2–1 in the first final. The current champion is the United States, after winning their third title in the 2015 FIFA Women's World Cup.
          ...
          <p> In the 1999 edition, one of the most famous moments of the tournament was American defender Brandi Chastain's victory celebration after scoring the Cup-winning penalty kick against China. She took off her jersey and waved it over her head (as men frequently do), showing her muscular torso as she celebrated. The 1999 final in the Rose Bowl in Pasadena, California had an attendance of 90,185, a world record for a women's sporting event.
